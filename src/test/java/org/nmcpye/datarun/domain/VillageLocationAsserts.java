...
public class VillageLocationAsserts {
     ...
     */
    public static void assertVillageLocationAllPropertiesEquals(VillageLocation expected, VillageLocation actual) {
        assertVillageLocationAutoGeneratedPropertiesEquals(expected, actual);
        assertVillageLocationAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertVillageLocationAllUpdatablePropertiesEquals(VillageLocation expected, VillageLocation actual) {
        assertVillageLocationUpdatableFieldsEquals(expected, actual);
        assertVillageLocationUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertVillageLocationAutoGeneratedPropertiesEquals(VillageLocation expected, VillageLocation actual) {
        assertThat(expected)
            .as("Verify VillageLocation auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertVillageLocationUpdatableFieldsEquals(VillageLocation expected, VillageLocation actual) {
        assertThat(expected)
            .as("Verify VillageLocation relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertVillageLocationUpdatableRelationshipsEquals(VillageLocation expected, VillageLocation actual) {}
}
