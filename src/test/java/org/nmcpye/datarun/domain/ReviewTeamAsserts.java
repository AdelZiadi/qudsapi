...
public class ReviewTeamAsserts {
    ...
    public static void assertReviewTeamUpdatableFieldsEquals(ReviewTeam expected, ReviewTeam actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getProgressOrname()).as("check progressOrname").isEqualTo(actual.getProgressOrname()))
            .satisfies(e -> assertThat(e.getProgressOrUser()).as("check progressOrUser").isEqualTo(actual.getProgressOrUser()));
    }
